<template>
  <div class="col-md-12 funcframe flex-auto" id="funcframe">
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
          <a
            ...
            role="tab"
            data-toggle="tab"
            v-on:click="favBtnOff"
            i18n-content="MENU_FAVORITE"
          ></a>
        </li>
      </ul>
    ...
    EventBus.$on('render_favorite', () => {
      ...
      if (localStorage) {
        ...
        for (let i in favorite_tab) {
          this.favUl =
            `<li data-url="${favorite_tab[i]['url']}" data-num="${i}">
                    <span>
    ...
    EventBus.$on('render_recent', () => {
      ...
      if (localStorage) {
        ...
        for (let i in recent_tab) {
          this.recentUl =
            `<li data-url="${recent_tab[i]['url']}" data-num="${i}">
                    <span>
                        <img class="li_bulb" src="/img/li_bulb_on.png">
